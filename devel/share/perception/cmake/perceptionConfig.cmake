...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/cuhsailus/Aerotech_Robot_Arm/src/perception)
  set(perception_DEVEL_PREFIX /home/cuhsailus/Aerotech_Robot_Arm/devel)
  ...
  set(perception_INSTALL_PREFIX /home/cuhsailus/Aerotech_Robot_Arm/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'cuhsailus <cuhsailus@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cuhsailus/Aerotech_Robot_Arm/src/perception/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cuhsailus/Aerotech_Robot_Arm/devel/lib;/home/cuhsailus/Aerotech_Robot_Arm/devel/lib;/opt/ros/melodic/lib)
